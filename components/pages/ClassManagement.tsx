...
import { Button, Table, Modal, Form, Input, Select, Tag, Space, Popconfirm, Descriptions } from 'antd';
...
const ClassManagement = () => {
    ...
    const filteredClasses = classes.filter(c => 
        filterStatus === 'all' || c['Trạng thái'] === filterStatus
    );
                ...
                {viewingClass && (
                    <div>
                        <Descriptions column={2} bordered>
                            <Descriptions.Item label="Mã lớp">{viewingClass['Mã lớp']}</Descriptions.Item>
                            <Descriptions.Item label="Tên lớp">{viewingClass['Tên lớp']}</Descriptions.Item>
                            <Descriptions.Item label="Môn học">{viewingClass['Môn học']}</Descriptions.Item>
                            <Descriptions.Item label="Khối">{viewingClass['Khối']}</Descriptions.Item>
                            ...
                            <Descriptions.Item label="Trạng thái">
                                <Tag color={viewingClass['Trạng thái'] === 'active' ? 'green' : 'red'}>
                                    {viewingClass['Trạng thái'] === 'active' ? 'Hoạt động' : 'Ngừng'}
                                </Tag>
                            </Descriptions.Item>
                        ...
                        {viewingClass['Lịch học'] && viewingClass['Lịch học'].length > 0 && (
                            <div style={{ marginTop: 24 }}>
                                ...
                                <Table
                                    dataSource={viewingClass['Lịch học'].map((schedule, index) => ({
                                        key: index,
                                        ...schedule
                                    }))}
                                    columns={[
                        ...
                        {viewingClass['Học sinh'] && viewingClass['Học sinh'].length > 0 && (
                            <div style={{ marginTop: 24 }}>
                                <h4>Danh sách học sinh ({viewingClass['Học sinh'].length}):</h4>
