...
const TeacherAttendance = () => {
    ...
    const myClasses = classes.filter(c => {
        ...
        const isWithinDateRange = (!startDate || today.isSameOrAfter(startDate, 'day')) &&
    ...
    const todayClasses = myClasses.filter(c => {
        return c['Lịch học']?.some(schedule => schedule['Thứ'] === todayDayOfWeek);
    }).sort((a, b) => {
        // Sort by start time
                                ...
                                >
                                    <List.Item.Meta
                                        ...
                                        description={
                                            <div>
                                                <div>
                                                    <ClockCircleOutlined /> {todaySchedule?.['Giờ bắt đầu']} - {todaySchedule?.['Giờ kết thúc']}
                                                    {todaySchedule?.['Địa điểm'] && ` • ${todaySchedule['Địa điểm']}`}
                                                </div>
