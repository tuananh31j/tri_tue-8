...
const TeacherClassView = () => {
    ...
    console.log('TeacherClassView - Filter info:', {
        ...
        actualTeacherId,
        allClasses: classes.map(c => ({ id: c.id, name: c['Tên lớp'], teacherId: c['Teacher ID'] }))
    });

    const myClasses = classes.filter(c => {
        const match = c['Teacher ID'] === actualTeacherId;
        console.log('Checking class:', c['Tên lớp'], 'Teacher ID:', c['Teacher ID'], 'Match:', match);
        return match;
    });
                            ...
                            <Card 
                                ...
                                extra={
                                    <Button
                                        ...
                                        onClick={() => navigate(`/workspace/classes/${classData.id}/history`)}
                                    >
                                        Lịch sử buổi học
                                    </Button>
                                }
                            ...
                            >
                                <Descriptions column={2}>
                                    ...
                                    <Descriptions.Item label="Trạng thái">
                                        <Tag color={classData['Trạng thái'] === 'active' ? 'green' : 'red'}>
                                            {classData['Trạng thái'] === 'active' ? 'Hoạt động' : 'Ngừng'}
                                        </Tag>
                                    </Descriptions.Item>
