...
import { Modal, Form, Input, Select, Button, Space, TimePicker, DatePicker } from 'antd';
...
const ClassFormModal = ({ open, onClose, editingClass }: ClassFormModalProps) => {
    ...
    useEffect(() => {
        if (editingClass) {
            ...
            form.setFieldsValue({
                ...
                startDate: editingClass['Ngày bắt đầu'] ? dayjs(editingClass['Ngày bắt đầu']) : null,
                endDate: editingClass['Ngày kết thúc'] ? dayjs(editingClass['Ngày kết thúc']) : null,
    ...
    const handleSubmit = async () => {
        try {
            ...
            const schedules: ClassSchedule[] = values.schedules?.map((s: any) => ({
                'Thứ': s.day,
            ...
            const classData = {
                ...
                'Lịch học': schedules,
                'Ngày bắt đầu': values.startDate ? values.startDate.format('YYYY-MM-DD') : '',
                'Ngày kết thúc': values.endDate ? values.endDate.format('YYYY-MM-DD') : '',
    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    <Select
                        placeholder={loadingTeachers ? "Đang tải danh sách giáo viên..." : "Chọn giáo viên"}
                        showSearch
                        ...
                        notFoundContent={loadingTeachers ? "Đang tải..." : "Không tìm thấy giáo viên"}
                    />
                </Form.Item>
